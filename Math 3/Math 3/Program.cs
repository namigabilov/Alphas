    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Array.Resize(ref numsD, numsD.Length + 1);
                numsD[numsD.Length - 1] = x0;
                j += e;
                if (j > x1)
                {
                    break;
            ...
            Console.WriteLine($"Funksiyanin Epslon = {e} deiqilikle X={point} noqtesindeki qiymeti {minValue} e beraberdir");
